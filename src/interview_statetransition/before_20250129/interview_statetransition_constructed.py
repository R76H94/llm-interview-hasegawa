# nohup python src/interview_statetransition/interview_statetransition_constructed.py > out/log/output_$(date +%Y%m%d_%H%M%S).log 2>&1 &
...
PROMPT_IDLE_TALK_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_idle_talk.txt"
)
PROMPT_FILL_SLOTS_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_fill_slots.txt"
)
PROMPT_GENERATE_SLOTS_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_generate_slots.txt"
)
PROMPT_GENERATE_QUESTIONS_PATH = "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_generating_question.txt"
PROMPT_USER_SIMULATOR_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_user_simulator.txt"
)
PROMPT_CAREER_TOPIC_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_career_topic.txt"
)
PROMPT_END_CONVERSATION_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/prompt_const/prompt_end_conversation.txt"
)

# ユーザシミュレータのpersona設定
PERSONA_SETTINGS_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/persona_settings/iwahashi_p.txt"
)

# 自己評価アンケート
SELF_EVALUATION_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/questionnaire/iwahashi_q.json"
)
