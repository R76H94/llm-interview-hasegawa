...
PERSONA_SETTINGS_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/persona_settings/mizutani_p.txt"
)

# 自己評価アンケート
SELF_EVALUATION_PATH = (
    "/mnt/work/interview/data/hashimoto-nakano/questionnaire/mizutani_q.json"
)
...
INTERVIEW_CONFIG = {
    ...
    "slots": {
        ...
        "プライベートでのリフレッシュ方法": {"category": "プライベート", "value": None},
        "来年のキャリア希望": {"category": "キャリア", "value": None},
        "研修の希望": {"category": "キャリア", "value": None},
        "現在取り組んでいること": {"category": "キャリア", "value": None},
        "必要なサポート": {"category": "キャリア", "value": None},
        "現在の業務でのやりがい": {"category": "キャリア", "value": None},
        "現在の業務で改善したい点": {"category": "キャリア", "value": None},
        "昇進に向けた具体的な目標": {"category": "キャリア", "value": None},
        "目指している役職やポジション": {"category": "キャリア", "value": None},
        "伸ばしたいスキル": {"category": "キャリア", "value": None},
        "目標達成のタイムライン": {"category": "キャリア", "value": None},
    },
}
