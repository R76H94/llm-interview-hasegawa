...
- 話題順モード: replay
- 話題順ファイル: /mnt/work/interview/out/zero-shot_few-shot/llm/20260205_215159/topic_order.json
...
```json
{
  ...
  "run": {
    "wait_time": 3,
    "out_dir": "/mnt/work/interview/out/zero-shot_few-shot/llm"
  },
  "interview": {
    "max_total_count": 50,
    "min_total_count": 50,
    ...
    "topic_mode": "replay",
    "topic_order_file": "/mnt/work/interview/out/zero-shot_few-shot/llm/20260205_215159/topic_order.json",
