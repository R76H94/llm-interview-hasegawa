...
- 話題順モード: replay
- 話題順ファイル: /mnt/work/interview/out/zero-shot_few-shot/topic_order.json
...
```json
{
  ...
  "run": {
    "wait_time": 3,
    "out_dir": "out/zero-shot_few-shot/IT/LLM/few-shot"
  },
  "interview": {
    "max_total_count": 50,
    "min_total_count": 50,
    ...
    "topic_mode": "replay",
    "topic_order_file": "/mnt/work/interview/out/zero-shot_few-shot/topic_order.json",
  ...
  "paths": {
    "prompts": {
      ...
      "estimate_persona": "/mnt/work/interview/data/hashimoto-nakano/prompt_semi_const/proposed_method/all_domain_tsuchida/prompt_estimate_persona_teacher_llm_fewshot.txt",
